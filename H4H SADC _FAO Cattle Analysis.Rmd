...
*One red flag to note: Jacques has yet to secure funding for this study. Sarah is paying half the bill, so I am proceeding with the analysis.*
...
To get some context to the region, there are a number of potentially useful datasets that we could use. For example, what is the climate like? Where are the people? Where are 
